                    ...
                    <div class="container">
                        <div class="row-fluid">
                            ...
                            <div class="span6 contact-form centered">
                                <form id="contact-form" action="reg.php" method="post">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <input class="span12" type="text" id="name" name="year" placeholder="* Year of registration of NGO..." required/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <div class="controls">
                                    ...
                                    <a href="register1.php">Register as a Volunteer</a>
                                </form>
                            </div>
                        </div>
                    </div>
