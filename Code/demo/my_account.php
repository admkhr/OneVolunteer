...
<html lang="en">
    ...
    <body>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container">
                    <?php $name = name_return(); ?>
                    <p style = "font-size: 20px;">Hello, <a href="my_account.php" style = "color: white;"><?php echo $name;?></a>!
                        <a href = "logout.php" style = "font-size: 17px; color: white; float: right;">Logout</a></p>
        ...
        <div id="contact">
            <div class="section secondary-section">
                    <div class="container">
                        <div class="row-fluid">
                            <div class="span12 contact-form centered">
                                ...
                                <p style="color:black; float:left;">Name: <?php echo $row['user_name']?></p>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                    ...
                    <div class="container">
                        <div class="row-fluid">
                            <div class="span12 contact-form centered">
                                <p style="color:black; float:left;">Contact Number: <?php echo $row['contact_no']?></p>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                    ...
                    <div class="container">
                        <div class="row-fluid">
                            <div class="span12 contact-form centered">
                                <p style="color:black; float:left;">Year of start of NGO: <?php echo $row['year']?></p>
                            </div>
                        </div>
                    </div>
                <div class="container">
