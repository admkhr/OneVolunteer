...
<?php
    ...
    mysql_query("INSERT INTO `users` (`user_name`, `address`, `contact_no`, `email`, `password`, `year`, `president`, `category`) VALUES ('$name', '$address', '$phone', '$email', '$password', '$year', '$president', '$category')");?>
    <html>
        <script>
